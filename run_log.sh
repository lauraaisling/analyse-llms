...
python scripts/compute_data.py --model_config_path preset_configs/pythia1160m-dpo.json --data_path data/val.jsonl --calculation_output_path outputs/pythia160m-dpo-calculation_data10000pc.p --calc_confidence True --calc_probs True --max_docs 10000
echo 'perplexity 160m'
python scripts/calc_perplexity.py --calculation_output_path outputs/pythia70m-base-calculation_data10000pc.p --output_path results/perplexity/pythia160m-base-perplexity.json
python scripts/calc_perplexity.py --calculation_output_path outputs/pythia70m-sft-calculation_data10000pc.p --output_path results/perplexity/pythia160m-sft-perplexity.json
python scripts/calc_perplexity.py --calculation_output_path outputs/pythia70m-dpo-calculation_data10000pc.p --output_path results/perplexity/pythia160m-dpo-perplexity.json
